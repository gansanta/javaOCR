 ...
 * @author gsb
 */
public class AddCharacterDialogClass {
    Dialog addCharDialog; 
    TextField textField;
    
    public AddCharacterDialogClass(Image charSnapshot, 
        ...
        textField.setPrefHeight(60);//Padauk
        textField.setFont(Font.font("Noto Sans Myanmar UI", FontWeight.NORMAL, 20));
//        textField.setFont(Font.font("Padauk", FontWeight.NORMAL, 20));
...
//        textField.requestFocus();
        ...
        addCharDialog = new Dialog(); //create a dialog
        addCharDialog.initModality(Modality.NONE);
        
        addCharDialog.setDialogPane(dgPane);// set the dialogpane to the dialog
